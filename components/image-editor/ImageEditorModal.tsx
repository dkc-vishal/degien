...
export default function ImageEditorModal({
  ...
  const {
    ...
    baseCanvasRef: baseCanvasRef as React.RefObject<HTMLCanvasElement>,
  });
  ...
  useEffect(() => {
    ...
    console.log(
      "ImageEditorModal: Loading image with URL:",
            ...
            >
              ...
              {activeTool === "curve" && (
                <CurveTool
                  ...
                  canvasRef={
                    drawingCanvasRef as React.RefObject<HTMLCanvasElement>
                  }
