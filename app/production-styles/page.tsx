    ...
    <div className="w-full px-6 py-8">
      <div className="flex justify-between items-center mb-6 border-b pb-4 border-gray-200">
        ...
        <div className="flex items-center gap-8 mr-32">
          <button className="inline-flex items-center gap-1 px-4 py-1.5 bg-blue-400 hover:bg-blue-500 text-white text-sm rounded-md transition cursor-pointer">
            <Plus className="w-4 h-4" />
            Create New Style
          </button>
          <button
            onClick={() => setViewMode(viewMode === "card" ? "list" : "card")}
            className="bg-gray-100 hover:bg-gray-200 text-gray-700 p-2 rounded-full transition cursor-pointer"
          >
